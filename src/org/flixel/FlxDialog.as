package org.flixel {
	...
	public class FlxDialog extends FlxGroup{
		...
		public function FlxDialog(X:Number=0, Y:Number=200, Width:Number=640, Height:Number=72, displaySpeed:Number=.45, background:Boolean=true, backgroundColor:uint=0x77000000)
		{				
			//x = X; 
			//y = Y;			
			_width 	= Width;
			...
			_bg = new FlxSprite(X,Y).makeGraphic(_width, _height, _backgroundColor);//adauga X,Y intre paranteze ca sa mearga pt 2.5 poz diferitade 0,0
 ...
 //modif sa nu mai apara dupa if(showing==true) tot
			super.update();
		}
